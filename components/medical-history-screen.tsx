...
export function MedicalHistoryScreen({ selectedPatientId }: MedicalHistoryScreenProps) {
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-950/50 dark:to-gray-900">
        <UnderConstruction
          ...
          description="View a comprehensive timeline of your pet's medical history, including past visits, diagnoses, treatments, and important medical notes. Track health trends and access historical records all in one place."
        />
      </div>
    </div>
  )
