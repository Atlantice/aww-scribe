...
export function DocumentsScreen({ selectedPatientId }: DocumentsScreenProps) {
  return (
    <div className="flex h-full">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col bg-white dark:bg-[#0a0a0a] border-r border-border">
        ...
        <div className="p-4 border-b border-border space-y-3">
          <h2 className="font-semibold text-lg text-foreground">Documents</h2>
      ...
      <div className="flex-1 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-950/50 dark:to-gray-900">
        <UnderConstruction
          icon={FolderOpen}
          title="Documents"
          description="Store and organize all important pet documents in one secure location. Upload medical records, certificates, insurance papers, and other files. Easily search, download, and share documents with your veterinary team whenever needed."
        />
      </div>
    </div>
  )
