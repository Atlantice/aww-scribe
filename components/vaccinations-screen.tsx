...
export function VaccinationsScreen({ selectedPatientId }: VaccinationsScreenProps) {
  return (
    <div className="flex h-full">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col bg-white dark:bg-[#0a0a0a] border-r border-border">
        ...
        <div className="p-4 border-b border-border space-y-3">
          <h2 className="font-semibold text-lg text-foreground">Vaccinations</h2>
      ...
      <div className="flex-1 bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-950/50 dark:to-gray-900">
        <UnderConstruction
          icon={Syringe}
          title="Vaccinations"
          description="Keep track of all vaccination records and immunization schedules. View upcoming vaccination dates, receive reminders for boosters, and maintain a complete immunization history for your pet's health and safety."
        />
      </div>
    </div>
  )
